# Runbook — sdkwork-aiot deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-aiot-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-aiot/bundle`, loads the image, starts
